...
int main()
{
	...
	std::vector<std::string> colors{ "cyan", "deepskyblue", "darkturquoise", "dodgerblue",
									 "cornflowerblue", "royalblue", "mediumblue", "blue",
									 "lightcoral", "indianred", "firebrick", "maroon", 
									 "darkred", "red", "salmon", "orangered" };
