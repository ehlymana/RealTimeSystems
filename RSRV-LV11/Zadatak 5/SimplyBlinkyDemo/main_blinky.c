...
static void prvQueueReceiveTask( void *pvParameters )
{
	...
	for( ;; )
	{
			...
			// pritisnuta oba dugmeta - upali crvenu, pa cekaj 100 ms, pa ugasi crvenu
			...
			// pritisnuto samo S1 - upali narandzastu, pa cekaj 200 ms, pa upali ljubicastu
			...
			// pritisnuto samo S2 - upali bijelu
			...
			// nijedno dugme nije pritisnuto - upali LED1
